...
from adaptive_quad import adaptive_quad
from adaptive_quad import eval_gauss_quad
from adaptive_quad import eval_composite_trap
from adaptive_quad import eval_composite_simpsons
import numpy as np
# get plot routines
...
Ms = 5
# storage for error
err_old = 0; # err_old = np.zeros((nM,))
err_new = 0; # err_new = np.zeros((nM,))
